const project = {
  "slug": "coding-agent-sandbox-policy",
  "title": "Coding Agent Sandbox Policy",
  "version": "1.0.0",
  "tagline": "Policy-as-code for AI coding agents touching files, networks, and secrets.",
  "problem": "Coding agents interact with legacy IDEs, terminals, package managers, and secrets that were not designed for autonomous behavior.",
  "solution": "A sandbox policy checker that validates file write roots, network rules, secret exposure controls, and command approval boundaries.",
  "required": [
    "sandbox.writableRoots",
    "sandbox.network",
    "secrets.envAllowed",
    "commands.destructiveRequireApproval",
    "commands.packageInstallRequireApproval"
  ],
  "opportunities": [
    "IDE adapters",
    "policy test suites",
